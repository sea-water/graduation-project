...
<Link to="/Community" style={{ textDecoration: "none" ,color:"black"}}><h1 className="c_center1">메인</h1></Link>
  <Link to="Cbest" style={{ textDecoration: "none" ,color:"black"}}><h1 className="c_center1">베스트</h1></Link>
  <Link to="Cplatfrom" style={{ textDecoration: "none" ,color:"black"}}><h1 className="c_center1">플랫폼</h1></Link>
  <Link to="Cinformation" style={{ textDecoration: "none" ,color:"black"}}><h1 className="c_center1">정보</h1></Link>
  </div>
