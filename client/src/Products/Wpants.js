...
function Wpants() {
    const pants=[["https://andar.co.kr/web/product/medium/202303/c9244b8bde16f8a1c69a76c2a6e369b7.jpg","셔츠","48411"],
    ...
    const wpants=pants.map((v)=>(<Manentiremap img={v[0]} name={v[1]} price={v[2]}/>));
    return (
