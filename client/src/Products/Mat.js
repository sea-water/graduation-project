...
function Mat(props) {
    const Mats=[["https://andar.co.kr/web/product/small/202303/bbfe47bb11413fcc1f24283eaf759442.jpg","손목보호대","123154"],
    ...
    const Mat=Mats.map((v)=>(<Manentiremap img={v[0]} name={v[1]} price={v[2]}/>));
    return (
